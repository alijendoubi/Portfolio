  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        console.error('Failed to fetch web dev projects:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <MainLayout>
      <Head>
        ...
        <meta
          name="description"
          content="Explore my web development projects including modern web applications, SaaS platforms, and responsive websites"
        />
      </Head>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              Web Development <span className="text-neon">Projects</span>
            </h1>
            <p className="text-xl text-gray-400">
              Modern, responsive, and scalable web applications built with cutting-edge technologies
            </p>
          </div>
        </div>
      </section>
