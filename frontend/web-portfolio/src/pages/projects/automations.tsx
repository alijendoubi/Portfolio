...
const AutomationsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        console.error('Failed to fetch automation projects:', error);
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <MainLayout>
      <Head>
        <title>Automation Projects | Portfolio</title>
        <meta
          name="description"
          content="Bots, workflows, and automation solutions for improved productivity and efficiency"
        />
      </Head>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold mb-6">
              Automation <span className="text-neon">Projects</span>
            </h1>
            <p className="text-xl text-gray-400">
              Intelligent bots and workflow automation for seamless operations
            </p>
          </div>
        </div>
      </section>
